      ...
      class Detailed
        ...
        private
          ...
          def education_intro
            ...
            span(325) do
              config_text[:education][:introduction].each do |t|
                text t, size: size, align: :justify, inline_format: true
                text '<br>', size: size, inline_format: true
              end
            end
          end
          ...
          def ed_award_builder(options = {})
            ...
            ed_award_body(
              y_pos: options[:y_2], key: options[:award], left: left, right: right, size: size
            )
          end
          ...
          def ed_award_result_size(users)
            ...
            "BPS::PDF::Roster::Detailed::BODY_#{size}_SIZE".constantize
          end
