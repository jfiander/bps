...
class Admin::PromoCodesController < ApplicationController
  ...
  def new
    ...
    @discount_types = [
      ['Percent off', 'percent'], ['Dollar reduction', 'usd'], ['Member cost', 'member'], ['USPS cost', 'usps']
    ]
...
private
  ...
  def promo_params
    params.require(:promo_code).permit(:code, :valid_at, :expires_at, :discount_type, :discount_amount)
  end
