...
module TimeHelper
  ...
  MEDIUM_TIME_FORMAT = "#{SHORT_DATE}/%Y @ #{TIME}"        # 1/1/2019 @ 0000
  SHORT_TIME_FORMAT = "#{SHORT_DATE} @ #{TIME}"            # 1/1 @ 0000
  EVENT_DATE_FORMAT = VERBOSE_DATE                         # Tue 01 Jan 2019
  SIMPLE_DATE_FORMAT = "#{SHORT_DATE}/%Y"                  # 1/1/2019
