...
RSpec.describe ReceiptPDF, type: :lib do
  before(:each) do
    generic_seo_and_ao
    @user = FactoryBot.create(:user)
  end

  it 'should successfully generate a receipt for a user registration' do
  ...
  it 'should successfully generate a receipt for a member application' do
    member_app = FactoryBot.create(:member_application, :with_primary)
    expect { member_app.payment.receipt! }.not_to raise_error
  end

  it 'should successfully generate a receipt for annual dues' do
