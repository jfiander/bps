Rails.application.routes.draw do
  ...
  # User management
  get     '/profile',                       to: redirect('/users/current')
  ...
  get     '/permit',                        to: 'permissions#permissions_index'
  post    '/permit',                        to: 'permissions#permissions_add'
  delete  '/permit',                        to: 'permissions#permissions_remove'
